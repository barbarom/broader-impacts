	...
	function editResource(resourceid) {
		...
		$.post(MyAjax.ajaxurl, data, function(response) {	
			for(var i = 0; i < response.length ; i++) {	
				...
				$("#extension").val(response[i].extension[0]);
